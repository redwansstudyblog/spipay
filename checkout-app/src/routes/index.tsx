...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "সিকিউর চেকআউট | spipay" },
      { name: "description", content: "মোবাইল ব্যাংকিং দিয়ে নিরাপদে পেমেন্ট নিশ্চিত করুন — spipay checkout." },
      { property: "og:title", content: "সিকিউর চেকআউট | spipay" },
      { property: "og:description", content: "মোবাইল ব্যাংকিং দিয়ে নিরাপদে পেমেন্ট নিশ্চিত করুন।" },
      ...
      <header className="mx-auto flex w-full max-w-[480px] items-center justify-between px-4 py-5">
        <div className="flex items-center gap-2.5">
          <div className="grid size-9 place-items-center overflow-hidden rounded-lg shadow-lg shadow-brand/20">
            <img src="/spipay-logo.png" alt={`${merchantConfig.brandName} logo`} className="size-full object-cover" />
          </div>
          <div>
